...
(function($wnd, $doc){
  ...
  var badBrowser = 'Unable to load Super Dev Mode of "com.quinto.QuintoOnline" because\n';
  ...
  $wnd.__gwt_activeModules['com.quinto.QuintoOnline'] = {
    'moduleName' : 'com.quinto.QuintoOnline',
    'bindings' : function() {
      return {};
    }
  };
 ...
 * "/com.quinto.QuintoOnline.nocache.js" is the one that loaded us. Normally this happens
...
function computeScriptBase() {
  ...
  $wnd.__gwt_activeModules['com.quinto.QuintoOnline'].superdevmode = true;

  var expectedSuffix = '/com.quinto.QuintoOnline.nocache.js';
  ...
  $wnd.alert('Unable to load Super Dev Mode version of ' + com.quinto.QuintoOnline + ".");
}
;
  ...
  var devModeHookKey = '__gwtDevModeHook:com.quinto.QuintoOnline';
  var devModeSessionKey = '__gwtDevModeSession:com.quinto.QuintoOnline';

  // Compute some codeserver urls so as the user does not need bookmarklets
  var hostName = $wnd.location.hostname;
  var serverUrl = 'http://' + hostName + ':9876';
  var nocacheUrl = serverUrl + '/com.quinto.QuintoOnline/com.quinto.QuintoOnline.nocache.js';
  ...
  $wnd.__gwt_activeModules['com.quinto.QuintoOnline'].canRedirect = true;
  $wnd.__gwt_activeModules['com.quinto.QuintoOnline'].superdevmode = true;
  ...
  css = (moduleIdx == 1 ? css : '') +
    ".gwt-DevModeModule-" + moduleIdx + ".gwt-DevModeCompiling div:before{" +
      "content:'COMPILING com.quinto.QuintoOnline';" +
      "font-size:24px;" +
      "color:#d2d9ee;" +
    "}";
  ...
  $wnd[compileFunction] = function() {
    ...
    compileScript.src = serverUrl +
      '/recompile/com.quinto.QuintoOnline?user.agent=' + ua + '&_callback=' + callback;
